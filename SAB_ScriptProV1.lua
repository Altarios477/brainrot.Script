...
local dragFrame = Instance.new("Frame", gui) dragFrame.Size = UDim2.new(0, 230, 0, 25) dragFrame.Position = UDim2.new(0, 20, 0.28, 0) dragFrame.BackgroundTransparency = 1 dragFrame.Active = true dragFrame.Draggable = true
...
toggleBtn.MouseButton1Click:Connect(function() main.Visible = not main.Visible dragFrame.Visible = main.Visible toggleBtn.Text = main.Visible and "📂 Скрыть меню" or "📂 Открыть меню" end)
